    ...
    sections: [
      {
        properties: {},
        children: [
          createParagraph("MEMORANDUM OF SECOND APPEAL", paragraphStyles.headingCenter),
          createParagraph("(UNDER SECTION 100 OF C.P.C.)", paragraphStyles.center),
          ...
          createParagraph("A.S.No. _______ OF 2007", paragraphStyles.startText),

          createParagraph("IN THE HIGH COURT OF JUDICATURE : ANDHRA PRADESH AT HYDERABAD", paragraphStyles.center),
          createParagraph("S.A.No. _______ OF 2007", paragraphStyles.center),
          ...
          createParagraph(
            "The above named Appellant begs to present this Memorandum of Second Appeal against the Judgment passed in A.S.No. ___ of 2007, Dt. __________, confirming/reversing the orders passed in O.S.No. _______ of _______, Dt. _______, on the file of _________________, __________. For the following grounds among other:",
            paragraphStyles.paragraph
          ),
          ...
          createParagraph(
            "The value of Appeal is as mentioned in the Lower Court, i.e., Rs.____________ and the Court Fee payable thereon is Rs._____/- and the same is sufficient under the A.P.C.F. and S.V.Act.",
            paragraphStyles.paragraph
          ),
          ...
          createParagraph("____________ DISTRICT", paragraphStyles.center),
          ...
          createParagraph("S.A.M.P.No. _______ OF 2007", paragraphStyles.center),
...
const generateAndDownloadSecondAppealDocx = (formData) => {
  const doc = SecondAppealTemplate(formData);
  Packer.toBlob(doc).then((blob) => saveAs(blob, "SecondAppeal.docx"));
};

export default generateAndDownloadSecondAppealDocx;
