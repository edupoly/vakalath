    ...
    <Document>
        <Page size="A4">
            <View style={styles.page}>
                <Text style={[styles.heading, styles.centerText, { marginBottom: 4 }]}>MEMORANDUM OF SECOND APPEAL</Text>
                <Text style={[styles.centerText]}>(UNDER SECTION 100 OF C.P.C.)</Text>
                <Text style={[styles.centerText, { marginTop: 10 }]}>IN THE COURT OF THE _________________________________________</Text>
                <Text style={styles.startText}>O.S.No. _______ OF 2007</Text>
                <Text style={[styles.centerText, { marginTop: 15 }]}>IN THE COURT OF THE _________________________________________</Text>
                <Text style={styles.startText}>A.S.No. _______ OF 2007</Text>
                <Text style={[styles.centerText, { marginTop: 15 }]}>IN THE HIGH COURT OF JUDICATURE : ANDHRA PRADESH AT HYDERABAD</Text>
                <Text style={[styles.centerText, { marginBottom: 20 }]}>S.A.No. _______ OF 2007</Text>
                ...
                <Text style={[styles.paragraph, { marginTop: 20 }]}>The above named Appellant begs to present this Memorandum of Second Appeal against the Judgment passed in A.S.No. ___ of 2007, Dt. __________, confirming/reversing the orders passed in O.S.No. _______ of _______, Dt. _______, on the file of _________________, __________. For the following grounds among other:</Text>
            ...
            <View style={styles.page} break>
                <Text style={[styles.item, { marginTop: 10 }]}>5.</Text>
                <Text style={[styles.heading, styles.centerText, { marginTop: 40 }]}>MEMO OF VALUATION</Text>
                <Text style={[styles.paragraph, { marginTop: 15 }]}>The value of Appeal is as mentioned in the Lower Court, i.e., Rs.____________ and the Court Fee payable thereon is Rs._____/- and the same is sufficient under the A.P.C.F. and S.V.Act.</Text>
            ...
            <View style={styles.page} break>
                <Text style={[styles.centerText, { marginBottom: 10 }]}>____________ DISTRICT</Text>
                <Text style={styles.centerText}>HIGH COURT : HYDERABAD</Text>
                <View style={{ marginTop: 20 }}>
                    <Text style={styles.centerText}>S.A.No. _______ OF 2007</Text>
            ...
            <View style={styles.page} break>
                ...
                <Text style={[styles.centerText, { marginBottom: 10 }]}>S.A.M.P.No. _______ OF 2007</Text>
