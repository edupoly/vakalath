...
import { trcmpSections } from "./trcmpData";

export const TRCMPTemplate = (formData) => {
    return new Document({
        sections: [
            {
                properties: {},
                children: [
                    ...combinedSections(trcmpSections("affidavit", formData), formData),
                    ...
                    h3Right("Deponent"),
                    pageBreak(),
                    ...combinedSections(trcmpSections("sec_24", formData), formData),
                    pageBreak(),
                    pageTable(trcmpSections("sidePage1", formData), formData),
                    pageBreak(),
                    ...combinedSections(trcmpSections("151", formData), formData),
                    pageBreak(),
                    pageTable(trcmpSections("sidePage2", formData), formData),
                    pageBreak(),
                    pageTable(trcmpSections("sidePage3", formData), formData),
                    pageBreak(),
