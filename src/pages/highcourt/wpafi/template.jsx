        ...
        sections: [
            {
                ...
                children: [
                    ...
                    ...LineSpace(1),
                    createParagraph(
                        `${tabSpace(1)}The petitioner has not filed any writ petition, suit or other proceedings for the relief or relieves sought herein.`,
                        paragraphStyles1.paragraph
                    ),
                    ...LineSpace(1),
                    createParagraph(
                        `${tabSpace(1)}It is therefore prayed that this Hon'ble Court may be pleased to issue a Writ, Order or direction more particularly one in the nature of Writ of Mandamus declaring ${formData?.MAIN_PRAYER || "_________"} and pass such other order or orders may deem fit and proper in the circumstances of the case.`,
                        paragraphStyles1.paragraph
                    ),
                    ...LineSpace(1),
                    createParagraph(
                        `${tabSpace(1)}It is also just and necessary that this Hon'ble Court may be pleased ${formData?.INTERIM_PRAYER || "_________"} pending disposal of the above writ petition and pass such other order or orders may deem fit and proper in the circumstances of the case.`,
                        paragraphStyles1.paragraph
                    ),
                    ...LineSpace(1),
