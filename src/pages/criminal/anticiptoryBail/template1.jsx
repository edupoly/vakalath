...
import { createParagraph, getPetitionersParagraphs, paragraphStyles } from "../../../services/templateFunctions";
    ...
    sections: [
      {
        properties: {},
        children: [
          createParagraph("MEMORANDUM OF CRIMINAL PETITION", paragraphStyles.headingCenter),
          createParagraph("(UNDER SECTION 438 CRIMINAL PROCEDURE CODE)", paragraphStyles.center),
          ...
          createParagraph(`CRL.P.No. ${formData?.CrlpNo || "________"} OF 2007`, paragraphStyles.caseNo),
          ...
          createParagraph("THE STATE OF A.P. REP. BY", paragraphStyles.startText),
          ...
          createParagraph("PETITION FOR ANTICIPATORY BAIL", paragraphStyles.headingCenter),
          createParagraph(
            `The petitioner is accused in Crime No. ${formData?.CrimeNumber || "____"} of 2007 of ${formData?.PoliceStationName || "____"} Police Station. He is alleged to have committed offenses punishable under Sections ${formData?.Sections || "____"}. He is apprehending arrest in the above crime.`,
            paragraphStyles.paragraph
          ),
          ...Array.from({ length: 10 }, (_, i) =>
            createParagraph(`${i + 1}. The petitioner submits that ...`, paragraphStyles.item)
          ),
          createParagraph(
          ...
          createParagraph(`${formData?.Place || "________"} DISTRICT`, paragraphStyles.rightLane),
          createParagraph("HIGH COURT HYDERABAD", paragraphStyles.centeredText),
          createParagraph(`Crl.P.No. ${formData?.CrlpNo || "________"} OF 2007`, paragraphStyles.centeredText),
          createParagraph("PETITION FOR ANTICIPATORY BAIL", paragraphStyles.headingAlt),
