...
function RevisionCaseForm({ caseType, formData, setFormData, modalRef }) {
    ...
    const vakalathForm = useFormik({
        ...
        initialValues: {
            ...
            FineStatus: "",
            AppealBailStatus: "",
            RevisionCaseNumberInBailPetition: "",
            JailName: "",
            BailCourtName: "",
            PetitionNumber: "",
            PetitionDate: "",
       ...
       <>
        <form onSubmit={vakalathForm.handleSubmit} className=" ">
            ...
            <div className="row row-cols-1 row-cols-md-2 row-cols-xl-3 mb-3">
                ...
                <FloatingInput id="RevisionCaseNumber" name="RevisionCaseNumber" label="Revision Case Number" value={vakalathForm.values.RevisionCaseNumber} type="text" onChange={vakalathForm.handleChange} />
                ...
                <FloatingInput id="CCNumber" name="CCNumber" label="C.C. Number" value={vakalathForm.values.CCNumber} type="text" onChange={vakalathForm.handleChange} />
                <FloatingInput id="CCTrialCourtName" name="CCTrialCourtName" label="C.C. Trial Court Name" value={vakalathForm.values.CCTrialCourtName} type="text" onChange={vakalathForm.handleChange} />
                ...
                <FloatingInput id="AppealBailStatus" name="AppealBailStatus" label="Appeal Bail Status" value={vakalathForm.values.AppealBailStatus} type="text" onChange={vakalathForm.handleChange} />
                <FloatingInput id="RevisionCaseNumberInBailPetition" name="RevisionCaseNumberInBailPetition" label="Revision Case Number In Bail Petition" value={vakalathForm.values.RevisionCaseNumberInBailPetition} type="text" onChange={vakalathForm.handleChange} />
...
export default RevisionCaseForm
